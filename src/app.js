...
Please make a backup of your contracts and start using http://remix.ethereum.org`)
  ...
  let swapPanelContainer = swapPanelApi.getParent()

  self._components.filePanel = new FilePanel()
  registry.put({api: self._components.filePanel, name: 'filepanel'})
  var filePanel = self._components.filePanel.render()
  swapPanelContainer.appendChild(dom)
  ...
  swapPanelContainer.appendChild(compileTab.render())
  ...
  swapPanelContainer.appendChild(testTab.render())
  ...
  swapPanelContainer.appendChild(runTab.render())
  ...
  swapPanelContainer.appendChild(analysisTab.render())
  ...
  swapPanelContainer.appendChild(debuggerTab.render())
  ...
  swapPanelContainer.appendChild(supportTab.render())
  ...
  const settingsTab = new SettingsTab()(self._components.registry)
  swapPanelContainer.appendChild(settingsTab.render())
